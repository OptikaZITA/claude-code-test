...
import { useSomedayTasks, useTasks } from '@/lib/hooks/use-tasks'
    ...
    <div className="h-full">
      ...
      <div className="p-6">
        ...
        <div className="mb-6 flex items-center gap-3">
          <Moon className="h-8 w-8 text-[var(--text-secondary)]" />
          <div>
            <h2 className="text-2xl font-bold text-[var(--text-primary)]">
              Niekedy
            </h2>
            <p className="text-sm text-[var(--text-secondary)]">
              Nápady a úlohy na neskôr
            </p>
          </div>
        </div>
        ...
        {tasks.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            <Moon className="mb-4 h-12 w-12 text-[var(--text-secondary)]" />
            <p className="mb-2 text-lg font-medium text-[var(--text-primary)]">
              Žiadne úlohy
            </p>
            <p className="mb-6 text-[var(--text-secondary)]">
              Úlohy ktoré možno urobíte v budúcnosti
            </p>
          </div>
        ) : null}
